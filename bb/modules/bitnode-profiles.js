...
export const BITNODE_PROFILES = {
  1: profile(1, "Source Genesis", HACK_DEFAULTS, cloud(64, 5e6), factionArgs([...HACKING_FACTIONS, "Sector-12"], "hacking")),
  ...
  4: profile(4, "The Singularity", [...HACK_DEFAULTS, "--reserve-home", "8"], cloud(64, 5e6), factionArgs([...HACKING_FACTIONS, "Sector-12"], "hacking")),
  5: profile(5, "Artificial Intelligence", HACK_DEFAULTS, cloud(64, 5e6), factionArgs(HACKING_FACTIONS, "hacking")),
